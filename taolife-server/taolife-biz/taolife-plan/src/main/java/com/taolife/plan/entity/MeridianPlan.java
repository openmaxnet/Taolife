...
/**
 * 经络方案实体类
 * 对应数据库表 tl_plan_meridian_plan
 *
 * @author 文二
 * @date 2026-04-06
 */
@Data
@Table("tl_plan_meridian_plan")
public class MeridianPlan implements Serializable {
     ...
     * 经络列表JSON
     */
    private String meridianList;

    /**
     * 经络调理重点
     */
    private String meridianFocus;

    /**
     * 调理原则JSON
     */
    private String regulationPrinciples;
    ...
    /**
     * 最佳操作时间：1-清晨，2-上午，3-下午，4-傍晚，5-晚上
     */
