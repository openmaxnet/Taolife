...
/**
 * 穴位方案实体类
 * 对应数据库表 tl_plan_acupoint_plan
 *
 * @author 文二
 * @date 2026-04-06
 */
@Data
@Table("tl_plan_acupoint_plan")
public class AcupointPlan implements Serializable {
     ...
     * 穴位列表JSON
     */
    private String acupointList;

    /**
     * 穴位按摩重点
     */
    private String acupointFocus;

    /**
     * 按摩原则JSON
     */
    private String massagePrinciples;

    /**
     * 按摩安排JSON
     */
    private String massageRoutine;
    ...
    /**
     * 最佳按摩时间：1-清晨，2-上午，3-下午，4-傍晚，5-晚上
     */
