  ...
  <div class="min-h-screen bg-white">
        ...
        <div class="flex justify-between items-center py-4">
          <div class="flex items-center space-x-4">
            <div class="w-10 h-10 flex items-center justify-center">
              <img src="/favicon.svg" alt="TaoLife Admin Logo" class="w-10 h-10" />
            </div>
            <span class="text-2xl font-bold text-gray-900">道养生活</span>
          </div>
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
          <h1 class="text-5xl md:text-7xl font-extrabold text-gray-900 mb-8 leading-tight">
            ...
            <span
              ...
              style="
                background: linear-gradient(to right, #56cb46, #4caf50);
        ...
        <div class="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div class="text-center">
            <div class="text-4xl font-bold text-gray-900 mb-2">{{ animatedStats.users }}+</div>
            <div class="text-gray-600">活跃用户</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-gray-900 mb-2">{{ animatedStats.projects }}+</div>
            <div class="text-gray-600">项目部署</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-gray-900 mb-2">{{ animatedStats.components }}+</div>
    ...
    <section id="features" class="py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-gray-900 mb-4">强大功能特性</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">为现代企业打造的全方位管理后台，集成最佳实践，开箱即用</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">极速性能</h3>
            <p class="text-gray-600">基于 Vite 构建，热重载迅速，生产环境优化，让开发体验更流畅</p>
          </div>
          ...
          <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <p class="text-gray-600">完善的权限管理体系，数据加密传输，让您的业务数据更安全</p>
          </div>
          ...
          <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">智能分析</h3>
            <p class="text-gray-600">内置数据可视化组件，多维度业务分析，助力数据驱动决策</p>
          </div>
          ...
          <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">用户友好</h3>
            <p class="text-gray-600">直观的界面设计，丰富的交互体验，降低学习成本，提升工作效率</p>
          </div>
          ...
          <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">高度定制</h3>
            <p class="text-gray-600">模块化架构设计，支持主题定制，灵活配置，满足不同业务需求</p>
          </div>
          ...
          <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">响应式设计</h3>
            <p class="text-gray-600">完美适配桌面端、平板和移动端，随时随地管理您的业务</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="demo" class="py-24 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600">无需登录，立即体验我们的核心功能</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-8">
            <div class="bg-gray-50 rounded-2xl p-8">
              <h3 class="text-xl font-semibold text-gray-900 mb-4">实时数据面板</h3>
            ...
            <div class="bg-gray-50 rounded-2xl p-8">
              <h3 class="text-xl font-semibold text-gray-900 mb-4">主题切换演示</h3>
          ...
          <div class="space-y-6">
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h4 class="text-lg font-semibold text-gray-900">多语言支持</h4>
                <p class="text-gray-600">内置中英文切换，支持更多语言扩展</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h4 class="text-lg font-semibold text-gray-900">暗色模式</h4>
                <p class="text-gray-600">护眼暗色主题，适合长时间使用</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h4 class="text-lg font-semibold text-gray-900">权限管理</h4>
                <p class="text-gray-600">细粒度权限控制，角色灵活分配</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h4 class="text-lg font-semibold text-gray-900">数据可视化</h4>
                <p class="text-gray-600">丰富的图表组件，数据展示更直观</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-24" style="background: linear-gradient(to right, #56cb46, #4caf50)">
      <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h2 class="text-4xl font-bold text-white mb-6">开始构建您的管理系统</h2>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8">
          <div>
            <div class="flex items-center space-x-2 mb-4">
              <div class="w-10 h-10 flex items-center justify-center">
                <img src="/favicon.svg" alt="TaoLife Admin Logo" class="w-8 h-8" />
              </div>
              <span class="text-xl font-bold text-white">道养生活</span>
            </div>
            <p class="text-gray-400">现代化的企业级管理后台解决方案</p>
          </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center">
          <p class="text-gray-400">
            © 2024 道养生活. 保留所有权利。这是一个公共访问示例页面，设置了 requiresAuth: false
          </p>
        </div>
      </div>
    </footer>
